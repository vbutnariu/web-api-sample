...
using Pm.WebApi.Ergodat.Core.Middleware;
using Pm.WebApi.Ergodat.Middleware;
using Pm.Core.Data;
using Pm.WebApi.Ergodat.Infrastructure.Extensions;
using System.Text;
using Pm.WebApi.Ergodat.Core.Extensions;
	...
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddSwaggerGen(c =>
			{
				...
				c.SwaggerDoc("v1", new OpenApiInfo { Title = "Ergonomed Web API service", Version = "v1" });
