...
namespace Demo.Core.Infrastructure
{
    public abstract class AppDomainTypeFinder : ITypeFinder
    {
        ...
        public IEnumerable<Type> FindClassesOfType(Type assignTypeFrom, IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
            ...
            try
            {
                foreach (var a in assemblies)
                {
                    ...
                    {
                        ProcessTypeInternal(assignTypeFrom, onlyConcreteClasses, result, t);
                    }
        ...
        private void ProcessTypeInternal(Type assignTypeFrom, bool onlyConcreteClasses, List<Type> containerTypes, Type targetType)
        {
            if (assignTypeFrom.IsAssignableFrom(targetType) || (assignTypeFrom.IsGenericTypeDefinition && DoesTypeImplementOpenGeneric(targetType, assignTypeFrom)))
            {
